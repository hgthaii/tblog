...
var me = (() => {
  ...
  m = {
    ...
    nextBulletRegex: u =>
      new RegExp(`^ {0,${Math.min(3, u - 1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),
    hrRegex: u =>
      new RegExp(`^ {0,${Math.min(3, u - 1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),
...
`),
      ...
      for (; n.length > 0; ) {
        ...
        for (l = 0; l < n.length; l++)
          if (this.rules.other.blockquoteStart.test(n[l])) (o.push(n[l]), (a = !0));
...
var x = class u {
  ...
  constructor(e) {
    ...
    (this.options.pedantic
      ...
      : this.options.gfm &&
        ((t.block = E.gfm), this.options.breaks ? (t.inline = M.breaks) : (t.inline = M.gfm)),
